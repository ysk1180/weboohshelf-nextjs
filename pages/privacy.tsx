...
const Privacy: NextPage = () => {
  const title = 'プライバシーポリシー - Web本棚'
  const description = `Web上で本棚を共有できるサービスです。ログイン不要で簡単に本棚が作成できてシェアできます。`
  const url = `https://web-bookshelf.com/privacy`
  ...
  return (
    <>
      ...
      <div className="m-2 text-sm leading-relaxed text-gray-200">
        <Breadcrumbs list={[{display: 'プライバシーポリシー'}]} />
        <h1 className="text-xl mt-4 mb-3 text-gray-100">プライバシーポリシー</h1>
        ...
        <p>個人情報の開示・訂正・削除につきましては、開発者XアカウントのDMよりご依頼ください。</p>
        ...
        <p>本ポリシーに関するお問い合わせは、開発者XアカウントのDMよりお願いいたします。</p>
